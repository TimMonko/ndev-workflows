...
def test_workflow_container_get_workflow_info():
    ...
    # _workflow_roots shows roots (referenced but not defined)
...
def test_batch_workflow_all_tasks(tmp_path, qtbot):
    ...
    img = nImage(output_folder / 'cells3d2ch.tiff')
    # Our test workflow has 6 tasks: membrane-gb, membrane-threshold, membrane-label,
    # nucleus-gb, nucleus-threshold, nucleus-label
